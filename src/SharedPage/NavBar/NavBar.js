                    ...
                    <nav>
                      <ul class="space-y-4">
                        ...
                        <li>
                          <a
                            href="/"
                            class="inline-flex items-center justify-center w-full h-12 rounded bg-rose-600 px-12 py-3 text-sm font-medium text-white shadow rounded hover:bg-rose-700 focus:outline-none focus:ring active:bg-rose-500 sm:w-auto"
                            aria-label="Sign up"
                            title="Sign up"
                          >
                            Sign up
